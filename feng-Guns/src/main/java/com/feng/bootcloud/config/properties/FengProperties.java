package com.feng.bootcloud.config.properties;
 ...
 */
@Component
@ConfigurationProperties(prefix = FengProperties.PREFIX)
public class FengProperties {

    public static final String PREFIX = "fengs";
