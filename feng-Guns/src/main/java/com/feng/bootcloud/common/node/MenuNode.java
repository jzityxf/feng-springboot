package com.feng.bootcloud.common.node;
...
import com.feng.bootcloud.common.constant.state.IsMenu;
...
public class MenuNode implements Comparable {
    ...
    public static List<MenuNode> buildTitle(List<MenuNode> nodes) {
        ...
        FengProperties gunsProperties = SpringContextHolder.getBean(FengProperties.class);
